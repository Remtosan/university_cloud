...
//    }
    ...
    public function setResponseWithMessage($GE3PMessage, $code, $message)
    {
        $GE3PMessage[WEB_SERVICE_RESPONSE_SIGNATURE]['code'] = $code;
        $GE3PMessage[WEB_SERVICE_RESPONSE_SIGNATURE]['message'] = $message;
        $GE3PMessage[WEB_SERVICE_RESPONSE_SIGNATURE]['object'] = array();
        return $GE3PMessage;
    }
    ...
    public function setErrorResponse($GE3PMessage, $errorMessage)
    {
        $GE3PMessage[WEB_SERVICE_RESPONSE_SIGNATURE]['code'] = GE3PApiMessages::$GENERAL_ERROR_CODE;
        $GE3PMessage[WEB_SERVICE_RESPONSE_SIGNATURE]['message'] = $errorMessage;
        $GE3PMessage[WEB_SERVICE_RESPONSE_SIGNATURE]['object'] = array();
        return $GE3PMessage;
    }
